...
def main():
    ...
    out=json.dumps(statuses,ensure_ascii=False,indent=2);(root/"master-status.json").write_text(out,encoding="utf-8");(root/"status.json").write_text(out,encoding="utf-8")
    print(out)
